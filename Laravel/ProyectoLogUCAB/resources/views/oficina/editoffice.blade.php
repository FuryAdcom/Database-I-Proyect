	...
	<div class="contenido_ppal">
		...
		<form method="POST" action="/oficina/update">
			...
			<div class="form-group" style="width:49%; float: right;">
					...
					<input type="tel" pattern="[0-9]{11}" name="Telefono" value="{{old('Telefono', $telf)}}" class="form-control" placeholder="Introduzca el telefono (Formato: 0XXXXXXXXXX)" required>
				</div>
